...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storageManager = __webpack_require__(316);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var Observer = __webpack_require__(301);
	...
	var CustomApi = function CustomApi(websocketMock, onClose) {
		...
		if ( typeof window !== 'undefined' ) {
			var storageManager = __webpack_require__(316);
			option = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var CustomApi = __webpack_require__(333);
	var storageManager = __webpack_require__(316);
	...
	module.exports = {
		addTokenIfValid: function addTokenIfValid(token, callback) {
			...
			if ( typeof WebSocket === 'undefined' ) {
				api = new CustomApi(__webpack_require__(339))._originalApi;
			} else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppId = {
		...
		getAppId: function getAppId() {
			return _storageManager2.default.get('appId');
		}
	};
...
/******/ });
//# sourceMappingURL=index-b2da5531997f16c8fd07.map