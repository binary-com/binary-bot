  ...
  render() {
    ...
    return (
      ...
      >
            ...
            <div>
              <label title="Save your blocks individually in a collection. They will be added to your existing workspace (main blocks will be replaced) when loaded." htmlFor="Collection" style={{
        fontWeight: 'normal'
      }}>{translator.translateText('Save As Collection')}</label>
              <input title="Save your blocks individually in a collection. They will be added to your existing workspace (main blocks will be replaced) when loaded." name="Collection" type="checkbox" id="saveAsCollection" style={{
        marginLeft: '4px'
      }} />
              <button
