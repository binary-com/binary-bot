...
export default class MakeSimpleStrategy {
  constructor() {
    this.tour = null
  ...
  getSteps() {
    return [{
      content: '<p>' + translator.translateText('Welcome to the first lesson, in this lesson we will learn how to define a simple strategy. Skip this tutorial by clicking on the <b>X</b> button. Skip each step by <b>Right Arrow (') + '&rarr;' + translator.translateText(')</b> on the keyboard.') + '</p>',
      closeButton: true,
