        ...
        <div className='about-trade-wrapper-inner section-container'>
            ...
            <div className='about-trade-wrapper-inner-info'>
                <div className='about-trade-wrapper-inner-info-location'>
                    <p>{translate('In the EU, financial products are offered by Deriv Investments (Europe) Limited, W Business Centre, Level 3, Triq Dun Karm, Birkirkara BKR 9033, Malta, licensed in Malta (')}<b><a href="https://www.binary.com/download/WS-Deriv-Investments-Europe-Limited.pdf" target="_blank">{translate('licence no. IS/70156' )}</a></b>
                    ...
                    <p>{translate('Outside the EU, financial products are offered by the following companies: Deriv (FX) Ltd, F16, Level 1, Paragon Labuan, Jalan Tun Mustapha, 87000 Labuan, Malaysia, licensed by Labuan Financial Services Authority (')}<a href="https://www.binary.com/download/regulation/Labuan-license.pdf" target="_blank"><b>{translate('licence no. MB/18/0024')}</b></a>{translate(') Deriv (BVI) Ltd, Kingston Chambers, P.O. Box 173, Road Town, Tortola, British Virgin Islands, licensed by the British Virgin Islands Financial Services Commission (')}<a href="https://www.binary.com/download/regulation/BVI_license.pdf" target="_blank"><b>{translate('licence no. SIBA/L/18/1114')}</b></a>{translate(')  Deriv(V) Ltd (')}<b>{translate('view licence')}</b>{translate('), 1276, Kumul Highway, Port Vila, Vanuatu, licensed and regulated by the Vanuatu Financial Services Commission; and Deriv (SVG) LLC, Hinds Buildings, Kingstown, St.Vincent and the Grenadines.')}</p>
