export default {
    carouselContentArray: [
        ...
        {
            title      : 'It’s the same Binary Bot you know and love',
            content    : 'Everything is exactly the way you like it.',
            action_text: 'Try Binary Bot on Deriv',
            img        : 'image/2a.webm',
        },
        {
    ...
    carouselContentLeftArray: [
        {
            title  : '7 trading platforms — old favourites and new ones, too',
            content:
    ...
    carouselContentRightArray: [
        {
            title  : 'Cryptocurrency deposits via fiat on-ramp',
            content: 'Make crypto deposits easily via exchange services such as Changelly, Banxa, and XanPool.',
            img    : 'image/fiat-on-ramp.svg',
        },
        {
            title  : 'Peer-to-peer deposits and withdrawals',
            content:
    ...
    //     'translate(\'Outside the EU, financial products are offered by the following companies: Deriv(FX) Ltd, F16, Level 1, Paragon Labuan, Jalan Tun Mustapha, 87000 Labuan, Malaysia, licensed by Labuan Financial Services Authority(\')}<b>{translate(\'licence no.MB / 18 / 0024\')}</b> {translate\') Deriv(BVI) Ltd, Kingston Chambers, P.O.Box 173, Road Town, Tortola, British Virgin Islands, licensed by the British Virgin Islands Financial Services Commission(\')}<b>{translate(\'licence no.SIBA / L / 18 / 1114\')}</b> {translate(\') Deriv(V) Ltd(\')}<b>{translate(\'view licence\')}</b> {translate(\'), 1276, Kumul Highway, Port Vila, Vanuatu, licensed and regulated by the Vanuatu Financial Services Commission; and Deriv(SVG) LLC, Hinds Buildings, Kingstown, St.Vincent and the Grenadines.\')',
