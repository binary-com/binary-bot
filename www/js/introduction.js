var Introduction = function Introduction(_event){
	this._event = _event;
	this.components = {
...
Introduction.prototype.setOpacityForAll = function setOpacityForAll(opacity){
...
Introduction.prototype.start = function start(){
  var steps = [
    {
      ...
      setup: function(tour, options) {
				Bot.introduction.setOpacityForAll(0.3);
      },
    },
    {
      ...
      at: 'bottom center',
      setup: function(tour, options) {
				Bot.introduction.components.workspace.css('opacity', 1);
      },
    ...
    },
    {
      ...
      setup: function(tour, options) {
				Bot.introduction._event.addEventListener('tour:submarket_created', this.tour_submarket_created);
				...
				Bot.introduction.components.toolbox.css('opacity', 1);
      },
      teardown: function(tour, options) {
				Bot.introduction._event.removeEventListener('tour:submarket_created', this.tour_submarket_created);
				Bot.introduction.components.toolbox.css('opacity', 0.3);
      },
    },
    {
      content: '<p>Great! Now add it to the <b>trade</b> block.</p>',
      target: Bot.introduction.components.workspace.find(".blocklyDraggable:contains('Submarket'):last"),
      highlightTarget: true,
      my: 'top center',
      at: 'bottom center',
      ...
      setup: function(tour, options) {
				Bot.introduction._event.addEventListener('tour:submarket', this.tour_submarket_added);
      },
      teardown: function(tour, options) {
				Bot.introduction._event.removeEventListener('tour:submarket', this.tour_submarket_added);
    ...
    },
    {
      ...
      setup: function(tour, options) {
				Bot.introduction._event.addEventListener('tour:condition_created', this.tour_condition_created);
				Blockly.mainWorkspace.toolbox_.tree_.children_[6].children_[1].select();
				Bot.introduction.components.toolbox.css('opacity', 1);
      },
      teardown: function(tour, options) {
				Bot.introduction._event.removeEventListener('tour:condition_created', this.tour_condition_created);
				Bot.introduction.components.toolbox.css('opacity', 0.3);
      },
    },
    {
      ...
      setup: function(tour, options) {
				Bot.introduction._event.addEventListener('tour:condition', this.tour_condition_added);
      },
      teardown: function(tour, options) {
				Bot.introduction._event.removeEventListener('tour:condition', this.tour_condition_added);
    ...
    },
    {
      ...
      setup: function(tour, options) {
				Bot.introduction._event.addEventListener('tour:number', this.tour_number_created);
				Blockly.mainWorkspace.toolbox_.tree_.children_[1].select();
				Bot.introduction.components.toolbox.css('opacity', 1);
      },
      teardown: function(tour, options) {
				Bot.introduction._event.removeEventListener('tour:number', this.tour_number_created);
				Bot.introduction.components.toolbox.css('opacity', 0.3);
      },
    },
    {
      ...
      setup: function(tour, options) {
				Bot.introduction._event.addEventListener('tour:ticks', this.tour_ticks_added);
      },
      teardown: function(tour, options) {
				Bot.introduction._event.removeEventListener('tour:ticks', this.tour_ticks_added);
      },
    },
    {
      ...
      setup: function(tour, options) {
				Blockly.mainWorkspace.toolbox_.tree_.children_[1].select();
				Bot.introduction._event.addEventListener('tour:options', this.tour_options_added);
				Bot.introduction.components.toolbox.css('opacity', 1);
      },
      teardown: function(tour, options) {
				Bot.introduction._event.removeEventListener('tour:options', this.tour_options_added);
				Bot.introduction.components.toolbox.css('opacity', 1);
      },
    },
    {
    ...
    },
    {
      ...
      target: Bot.introduction.components.workspace.find(".blocklyDraggable:contains('direction'):last"),
      highlightTarget: true,
      my: 'right center',
      at: 'left center',
			nextButton: true,
    ...
    },
    {
      ...
      setup: function(tour, options) {
				...
				Bot.introduction.components.toolbox.css('opacity', 1);
				Bot.introduction._event.addEventListener('tour:purchase_created', this.tour_purchase_created);
      },
      teardown: function(tour, options) {
				Bot.introduction.components.toolbox.css('opacity', 0.3);
				Bot.introduction._event.removeEventListener('tour:purchase_created', this.tour_purchase_created);
      },
    },
    {
      ...
      setup: function(tour, options) {
				Bot.introduction._event.addEventListener('tour:purchase', this.tour_purchase_added);
      },
      teardown: function(tour, options) {
				Bot.introduction._event.removeEventListener('tour:purchase', this.tour_purchase_added);
      },
    },
    {
    ...
    },
    {
      ...
      target: Bot.introduction.components.workspace.find(".blocklyDraggable:contains('details'):last"),
      highlightTarget: true,
      my: 'right center',
      at: 'left center',
			nextButton: true,
    ...
    },
    {
      ...
      setup: function(tour, options) {
				...
				Blockly.mainWorkspace.toolbox_.tree_.children_[6].children_[2].select();
				Bot.introduction.components.toolbox.css('opacity', 1);
				Bot.introduction._event.addEventListener('tour:trade_again_created', this.tour_trade_again_created);
      },
      teardown: function(tour, options) {
				Bot.introduction.components.toolbox.css('opacity', 0.3);
				Bot.introduction._event.removeEventListener('tour:trade_again_created', this.tour_trade_again_created);
      },
    },
    {
      ...
      setup: function(tour, options) {
				...
				Blockly.mainWorkspace.toolbox_.tree_.children_[6].children_[2].select();
				Bot.introduction.components.toolbox.css('opacity', 1);
				Bot.introduction._event.addEventListener('tour:trade_again', this.tour_trade_again);
      },
      teardown: function(tour, options) {
				Bot.introduction.components.toolbox.css('opacity', 0.3);
				Bot.introduction._event.removeEventListener('tour:trade_again', this.tour_trade_again);
				Blockly.mainWorkspace.toolbox_.tree_.children_[6].setExpanded(false);
      },
    },
    {
    ...
    },
    {
      ...
      at: 'left center',
			nextButton: true,
      teardown: function(tour, options) {
				Bot.introduction.setOpacityForAll(1);
      },
    },
    {
...
Bot.introduction = new Introduction(window);
