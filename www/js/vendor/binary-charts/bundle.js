...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commonRelativeBarrier = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	(function(J,ga){typeof module==="object"&&module.e?module.e=J.document?ga(J):ga:J.Highcharts=ga(J)})(typeof window!=="undefined"?window:this,function(J){function ga(a,b){var c="Highcharts error #"+a+": www.highcharts.com/errors/"+a;if(b)throw Error(c);J.console&&console.log(c)}function yb(a,b,c){this.options=b;this.elem=a;this.prop=c}function C(){var a,b=arguments,c,d={},e=function(a,b){var c,d;typeof a!=="object"&&(a={});for(d in b)b.hasOwnProperty(d)&&(c=b[d],a[d]=c&&typeof c==="object"&&
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reset = __webpack_require__(43);
	
	var _reset2 = _interopRequireDefault(_reset);
	
	var _plotOptions = __webpack_require__(41);
	
	var _plotOptions2 = _interopRequireDefault(_plotOptions);
	
	var _navigator = __webpack_require__(40);
	
	var _navigator2 = _interopRequireDefault(_navigator);
	
	var _rangeSelector = __webpack_require__(42);
	
	var _rangeSelector2 = _interopRequireDefault(_rangeSelector);
	
	var _yAxis = __webpack_require__(46);
	...
	var _seriesLine = __webpack_require__(44);
	...
	exports.default = function () {
	    return _extends({}, (0, _reset2.default)(), {
	        ...
	        yAxis: _extends({}, (0, _yAxis2.default)(), {
	            spotIndicator: {
	                enabled: true
	            }
	        }),
	        series: (0, _seriesLine2.default)([])
	    });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pipSizeAreEqual = function pipSizeAreEqual(prevProps, nextProps) {
	    return nextProps.trade && prevProps.trade && nextProps.trade.pipSize && prevProps.trade.pipSize && prevProps.trade.pipSize === nextProps.trade.pipSize;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commonPlotBands = __webpack_require__(4);
	
	var _relativeBarrier = __webpack_require__(5);
	
	var _relativeBarrier2 = _interopRequireDefault(_relativeBarrier);
	
	var _relativeBarrier3 = __webpack_require__(22);
	
	var _relativeBarrier4 = _interopRequireDefault(_relativeBarrier3);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	exports.default = function (contract, lastSpot) {
	    return [(0, _commonPlotBands.lossPlotBand)(0, (0, _relativeBarrier4.default)(contract, lastSpot)), (0, _commonPlotBands.winPlotBand)((0, _relativeBarrier2.default)(contract, lastSpot), (0, _relativeBarrier4.default)(contract, lastSpot)), (0, _commonPlotBands.lossPlotBand)((0, _relativeBarrier2.default)(contract, lastSpot), Number.MAX_VALUE)];
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (contract, lastSpot) {
	    return [(0, _commonPlotBands.winPlotBand)(0, (0, _relativeBarrier4.default)(contract, lastSpot)), (0, _commonPlotBands.lossPlotBand)((0, _relativeBarrier2.default)(contract, lastSpot), (0, _relativeBarrier4.default)(contract, lastSpot)), (0, _commonPlotBands.winPlotBand)((0, _relativeBarrier2.default)(contract, lastSpot), Number.MAX_VALUE)];
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _brandColor = __webpack_require__(6);
	
	var _brandColor2 = _interopRequireDefault(_brandColor);
	
	var _vertPlotLine = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.tradingTimes = exports.tickArray = exports.contractOrTrade = exports.barrierType = undefined;
	
	var _react = __webpack_require__(30);
	
	var barrierType = exports.barrierType = _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.number]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _plotBands = __webpack_require__(58);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getAbsoluteBarrier = function getAbsoluteBarrier(barrier, lastTickQuote) {
	    return typeof barrier === 'number' ? barrier : lastTickQuote + +barrier;
	};
	...
	var updateExtremesYAxis = function updateExtremesYAxis(axis, ticks, contract) {
	    ...
	    var lastTickQuote = (0, _getLastTick2.default)(ticks);
	    var minExtremes = [getAbsoluteBarrier(contract.barrier2, lastTickQuote), prevExtermes.dataMin].filter(function (x) {
	        return x;
	    });
	    var min = arrayMin(minExtremes);
	    var maxExtremes = [getAbsoluteBarrier(contract.barrier, lastTickQuote), prevExtermes.dataMax].filter(function (x) {
	        return x;
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dateToEpoch = __webpack_require__(66);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BinaryChart = __webpack_require__(31);
	
	var _BinaryChart2 = _interopRequireDefault(_BinaryChart);
	
	var _NonReactBinaryChart = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _callPutBarrier = __webpack_require__(20);
	
	var _callPutBarrier2 = _interopRequireDefault(_callPutBarrier);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	exports.default = function (contract, lastSpot) {
	    return [(0, _commonPlotBands.lossPlotBand)(0, (0, _callPutBarrier2.default)(contract, lastSpot)), (0, _commonPlotBands.winPlotBand)((0, _callPutBarrier2.default)(contract, lastSpot), Number.MAX_VALUE)];
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _upOrDownPlotBand = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rangePlotBand = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (contract, lastSpot) {
	    return [(0, _commonPlotBands.winPlotBand)(0, (0, _callPutBarrier2.default)(contract, lastSpot)), (0, _commonPlotBands.lossPlotBand)((0, _callPutBarrier2.default)(contract, lastSpot), Number.MAX_VALUE)];
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialize = function initialize(_ref) {
	    ...
	    spotIndicator.label = renderer.label(currentPrice.toFixed(2), priceYAxis.width + x, y - 8).attr({
	        padding: 1
	    }).css({
	        cursor: 'default',
	        textAnchor: 'end',
	...
	exports.default = function () {
	    var renderSpotIndicator = function renderSpotIndicator(chart) {
	        ...
	        if (priceYAxis.spotIndicator) {
	            update({ currentPrice: currentPrice, x: x, y: y, spotIndicator: priceYAxis.spotIndicator, priceYAxis: priceYAxis });
	        } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _doTicksEqual = __webpack_require__(69);
...
/***/ function(module, exports) {
	...
	exports.default = function (tick1, tick2) {
	    return !tick1 && tick1 === tick2 || // undefined tick should not be treated as equal in our context
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInvalidSetStateWarningDevTool = __webpack_require__(82);
	var warning = __webpack_require__(1);
